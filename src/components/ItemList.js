    ...
    <div className="mb-[3.5rem]">
      {items.map((item) => (
        <div
          ...
          className="flex justify-between my-3 hover:shadow-[0_0_10px_black] rounded-lg shadow-[8px_8px_8px_-10px_rgba(0,0,0,0.3)]"
        >
          ...
          <div className="w-3/12 p-4">
            <div className="absolute ml-[4%]">
              <button
                className=" p-0.5 text-white bg-black text-md hover:scale-95 hover:shadow-[0_0_3px_black] hover:bg-green-600 rounded-lg shadow-[0_0_1px_#adadad]"
