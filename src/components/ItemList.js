      ...
      {items.map((item) => (
        ...
        >
          <div className="m-2 p-3 w-9/12 hover:scale-95">
            ...
            <h1 className="mt-1 text-lg">Rs-{item.card.info.price / 100}</h1>
            <p className="mt-1 text-small">{item.card.info.description}</p>
          </div>

          <div className="w-3/12 p-4">
            <div className="absolute ml-[4%]">
              <button className=" text-white bg-black text-md hover:scale-95 hover:shadow-[0_0_3px_black] rounded-lg shadow-[0_0_1px_#adadad]">
                ADD+
              </button>
            </div>
            <img
