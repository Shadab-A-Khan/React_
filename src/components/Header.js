  ...
  return (
    <div className="flex item bg-center justify-between bg-orange-400 shadow-[0_-6px_10px_5px_rgba(0,0,0,0.5)]">
      <div className="logo-container">
        <img
          className="w-[200px] hover:bg-gre hover:translate-y-1 hover:scale-95 hover:shadow-[0_0_3px_black] shadow-[0_0_1px_#adadad]"
          src={LOGO_URL}
        />
      </div>
      <div className="px-5 py-0">
        <ul className="text-xl flex list-none pt-8">
          ...
          <li className="text-bold m-1 ml-0 mt-2.5 p-1 pl-0 hover:translate-y-1 hover:scale-95 hover:shadow-[0_0_3px_black] rounded-lg shadow-[0_0_1px_#adadad]">
            {" "}
            {onlineStaus == true ? "✅" : "❌"}
          </li>
        </ul>
